...
$project = [
    'name' => 'Проект электромонтажа двухкомнатной квартиры 60 м² (Бюджет)',
    'description' => 'Базовый проект электромонтажа для двухкомнатной квартиры площадью 60 м². Включает оптимальное количество розеток, базовое освещение и накладной электрощит. Идеальное решение для экономного ремонта.',
    'image' => $pageImage,
    'price' => '35550',
...
<body>
    ...
    <div class="container my-5">
        <h1 class="mb-4">Двухкомнатная квартира 60 м² (Вариант "Бюджет")</h1>
        
        <!-- Основная информация -->
        <div class="row mb-5">
            <div class="col-md-8">
                <div class="project-images mb-4">
                    <img src="../assets/images/projects/2-komn/kollag-2km-budget.jpg" alt="До ремонта" class="img-fluid mb-3">
                </div>
            </div>
            <div class="col-md-4">
        ...
        <div class="row mb-5">
            <div class="col-12">
                ...
                <p>Базовый вариант электромонтажа для двухкомнатной квартиры включает все необходимые элементы для комфортного проживания. Проект предусматривает оптимальное количество розеток и осветительных приборов для каждой комнаты, с учетом типового расположения мебели и бытовой техники.</p>
                <p>Проект подразумевает проведение электропроводки "с нуля", т.е. в квартире она полностью отсутствовала или же стала полностью непригодна (например алюминиевая). По данному проекту в квартире установлена газовая плита, поэтому расходы на монтаж силового кабеля для электроплиты не учтены. Для квартир не имеющих газа стоимость прокладки силового кабеля рассчитывается дополнительно.</p>
                <p>В данном варианте предусмотрено:</p>
                <ul>
                    <li>17 розеток (включая выделенные для стиральной машины и холодильника)</li>
                    <li>5 выключателей освещения</li>
                    <li>3 люстры</li>
                    <li>Отдельная группа для кухонной техники</li>
                </ul>
            </div>
        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="total-value" data-price="kabel" data-quantity="145">7 250 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Штроба (бетон)</td>
                                        <td>м.п.</td>
                                        ...
                                        <td class="total-value" data-price="shtroba" data-material="beton" data-quantity="26">7 800 ₽</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="total-value" data-price="otversty" data-quantity="4">800 ₽</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="total-value" data-price="ustKorobki" data-material="beton" data-quantity="22">6 600 ₽</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="total-value" data-price="korobka" data-quantity="9">2 700 ₽</td>
                                    </tr>
                                    <tr>
                                        <td>Монтаж накладного щита 18 модулей</td>
                                        <td>шт.</td>
                                        <td>1</td>
                                        <td class="price-value" data-price="shitok" data-type="nakladnoy" data-size="18">2 000 ₽</td>
                                        <td class="total-value" data-price="shitok" data-type="nakladnoy" data-size="18" data-quantity="1">2 000 ₽</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="total-value" data-price="tempLight" data-quantity="7">700 ₽</td>
                                    </tr>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><strong class="section-total">30 150 ₽</strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="total-value" data-price="socket" data-type="basic" data-quantity="17">2 550 ₽</td>
                                    </tr>
                                    <tr>
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="4" class="text-end"><strong>Итого:</strong></td>
                                        <td><strong class="section-total">5 400 ₽</strong></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
        ...
        <div class="row mb-5">
            <div class="col-12">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <a href="../assets/images/projects/2-komn/superbyudzhetnaya-2-komn.-plan-gruppy_page-0001.jpg" data-lightbox="plan" data-title="План расположения - страница 1">
                            <img src="../assets/images/projects/2-komn/superbyudzhetnaya-2-komn.-plan-gruppy_page-0001.jpg" alt="План расположения - страница 1" class="img-fluid rounded shadow-sm">
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="../assets/images/projects/2-komn/superbyudzhetnaya-2-komn.-plan-gruppy_page-0002.jpg" data-lightbox="plan" data-title="План расположения - страница 2">
                            <img src="../assets/images/projects/2-komn/superbyudzhetnaya-2-komn.-plan-gruppy_page-0002.jpg" alt="План расположения - страница 2" class="img-fluid rounded shadow-sm">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Оптимальная нагрузка</h5>
                                <p class="card-text">Грамотное распределение нагрузки по группам с учетом мощности бытовых приборов</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Использование современных автоматов защиты и УЗО для каждой группы потребителей</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="card-text">Оптимальное соотношение цены и качества для базового варианта электромонтажа</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            <img src="../assets/images/projects/2-komn/planirovka-2km-komfort.png" class="card-img-top" alt="Комфорт вариант">
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <img src="../assets/images/projects/1-komn/planirovka-1km-budget.png" class="card-img-top" alt="Однокомнатная бюджет">
                            <div class="card-body">
